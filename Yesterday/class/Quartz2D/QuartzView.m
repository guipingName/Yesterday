...
- (void)drawRect:(CGRect)rect {
    ...
    #pragma mark --------------- 文字 ----------------
    UIFont  *font = [UIFont systemFontOfSize:15.0];//设置
    ...
    CGContextAddArc(context, 250, 32, 30, 0, 2*M_PI, 0); //添加一个圆
    ...
    #pragma mark --------------- 图片 ----------------
    UIImage *image = [UIImage imageNamed:@"联动_成员列表_女3"];
    [image drawInRect:CGRectMake(60, 340, 20, 20)];//在坐标中画出图片
    //[image drawAtPoint:CGPointMake(100, 340)];//原图大小
    CGContextDrawImage(context, CGRectMake(100, 340, 20, 20), image.CGImage);// 图片上下颠倒
